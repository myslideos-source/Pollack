 ...
 */
export function WhatsAppFloatingButton({ contact }: { contact: ContactContent }) {
  return (
    <a
      href={contact.whatsappHref}
      target="_blank"
      rel="noreferrer"
      className="fixed bottom-6 right-6 z-40 hidden h-14 w-14 items-center justify-center rounded-full bg-moss text-ink shadow-xl transition-transform hover:scale-105 print:hidden xl:flex"
      aria-label={`Per WhatsApp schreiben: ${contact.whatsapp}`}
    >
