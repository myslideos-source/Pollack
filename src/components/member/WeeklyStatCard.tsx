...
export function WeeklyStatCard({
  ...
  return (
    <div className="grid grid-cols-3 divide-x divide-sp-border rounded-sp-lg border border-sp-border bg-sp-surface-1 shadow-sp-card">
      <div className="flex flex-col items-center justify-center gap-2 px-3 py-5">
        ...
        <p className="sp-headline -mt-11 text-xl font-bold text-sp-text">
          {sessionsThisWeek}/{weeklyGoal}
        </p>
        <p className="mt-7 text-center text-[11px] leading-tight text-sp-text-secondary">
          Wochenziel
          <br />
      ...
      <div className="flex flex-col items-center justify-center gap-2 px-3 py-5">
        <span className="text-sp-red">
          <SpBarChart size={24} strokeWidth={1.8} />
        </span>
      ...
      <div className="flex flex-col items-center justify-center gap-2 px-3 py-5">
        <span className="text-sp-red">
          <SpFlame size={24} strokeWidth={1.8} />
        </span>
