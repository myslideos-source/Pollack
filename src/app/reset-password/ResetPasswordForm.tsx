...
import { resetPasswordSharedAction, type AuthActionState } from "@/app/actions/member-auth";
...
export function ResetPasswordForm() {
  const [state, formAction, pending] = useActionState<AuthActionState, FormData>(resetPasswordSharedAction, null);
