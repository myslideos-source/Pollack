...
Kein Original-Bildmaterial und keine Original-Videos der alten Seite konnten eingebaut werden
(Zugriff blockiert, hochgeladene ZIP war zu groß für den Chat-Upload). Alle Bildflächen zeigen
aktuell die abstrakte `TexturePanel`-Platzhalterkomponente. Sobald echtes Material vorliegt,
richtet sich der Einbau nach der Checkliste in MEDIA_AUDIT.md.
...
| `/programm/kinderkarate` | Kinderkarate: Mindestalter, Selbstvertrauen, Selbstbehauptung, Grenzen, Schulweg/Pausenhof, Disziplin, Respekt | `/kampfkunst/kinderkarate` | Alle genannten pädagogischen Ziele übernommen, bewusst ohne Angstmache formuliert | Keine | Keine | Deutlich erweitert | Genaues Mindestalter |
